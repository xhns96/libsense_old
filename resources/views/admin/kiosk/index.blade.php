...
@section('content')
    ...
    <main>
        <section class="cd-section index cd-selected mt-0">
            <header>
                <div class="cd-title px-5">
                ...
                <div class="row">
                    ...
                    <div class="col-6" >
                        <div class="row">
                            <div class="col-3" style="text-align: right">
                                <img src="{{asset('storage/university-logos/13.jpg')}}" class="s200 rounded-circle" alt="">
                            </div>
                            <div class="col-9 pr-5" style="text-align: center">
                                <span style="font-size: 4rem">{{$currentUniversity->univer_name}}</span><br>
                                <span style="font-size: 4rem">Axborot - resurs markazi</span><br>
                                <div class="row">
                                    <div class="col-11">
                                        <select class="form-control-lg font-weight-bold custom-select mr-sm-2 boxShadow borderRadius20 inputPR20 mt-3" style="font-size: 2rem;padding-left: 20px" name="is-book-primary" id="all-campuses-select">
                                            <option selected disabled>O'quv zali yoki abonementni tanlang:</option>
                                            @forelse($allCampuses as $currentCampus)
                                                @if($currentCampus->campus_type=='abonement' || $currentCampus->campus_type == 'oquvzal')
                                    ...
                                    <div class="col-1">
                                        <button id="reload-page-btn" class="btn btn-danger rounded-circle mt-3 px-3" style="font-size: 2rem" disabled><i class="bi-arrow-repeat"></i></button>
                                    </div>    
                                </div>  
                            </div>
                        </div>
                    ...
                    <div class="col-12 mt-5">
                        <div class="row">
                            <div class="col-3"></div>
                            <div class="col-3">
                                <img src="{{asset('images/kiosk/qr_code.png')}}" class="s400" alt=""><br>
                                <span class="mt-3" style="font-size: 2rem">Kitobxonlik biletingizdagi<br> QR kodni skaner qiling</span>
                            </div>
                            <div class="col-3" id="qr-code-scanner-div">
    ...
    <nav class="cd-nav-container" id="cd-nav">
        ...
        <ul class="cd-nav">
            ...
            <li data-menu="projects">
                <a href="{{route('admin.kiosk.kundalik')}}">
					<span>
...
@section('footerScript')
    @parent
    <script src="{{asset('kiosk/js/index.js')}}"></script>
@endsection
