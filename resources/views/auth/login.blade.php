...
@section('headerStyles')
    @parent
{{--    <link rel="stylesheet" href="{{asset('css/book-page/loginPage.css')}}">--}}
@endsection
@section('content')
            ...
            <div class="card">
                <div class="card-body p-5">
                    <div class="row d-flex justify-content-center align-items-center">
                        ...
                        <div class="col-md-6">
                            <h4 class="text-center font-weight-bold">Tizimga kirish !</h4>
                                    ...
                                    <div class="d-flex justify-content-between">
                                        ...
                                        <div class="form-group col-md-6">
                                            <button type="submit" class="btn btn-primary btn-block col-md-12">
                                                Kirish <i class="bi bi-box-arrow-right"></i>
                                            </button>
...
{{--                <div class="card-header" style="color: grey"><b>KIRISH</b></div>--}}
