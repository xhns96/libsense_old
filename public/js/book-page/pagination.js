...
(function ($) {
    ...
    var preparePageMenus = function (current_page, pages, element) {
        ...
        menuHtml = '<li class="' + rpmListClass + ' prev ' + (current_page === fp ? 'disabled' : '') + '"><a class="' + rpmAnchorClass + '" href="#">Oldingi</a></li>';
        ...
        menuHtml += '<li class="' + rpmListClass + ' next ' + (current_page === lp ? 'disabled' : '') + '"><a class="' + rpmAnchorClass + '" href="#">Keyingi</a></li>';
