$(document).ready(function () {
    ...
    $('#all-books-table').dataTable().css('display','table');
    ...
    $("#all-books-table").on("click", ".btn-book", function(){
                ...
                if (recivedData.answer === 'hacked'){
                    ...
                    let modalContent = `
                                    ...
                                    <div class="col-6 mt-2">
                                        <input type="text" autocomplete="off" name="book-name" id="book-name" data-toggle="tooltip" data-placement="top" title="" class="form-control font-weight-bold boxShadow borderRadius20 inputPR20" placeholder="Adabiyot nomi:" value="${recivedData.answer['book_name']}" data-original-title="Adabiyot nomi.">
                                    </div>
                                    <div class="col-6 mt-2">
                                        <input type="text" autocomplete="off" name="book-author" id="book-author" data-toggle="tooltip" data-placement="top" title="" class="form-control font-weight-bold boxShadow borderRadius20 inputPR20" placeholder="Adabiyot muallifi:" value="${recivedData.answer['book_author']}" data-original-title="Adabiyot muallifi.">
                                    </div>
                                    ...
                                    <div class="col-3 mt-2">
                                        <input type="number" autocomplete="off" name="book-page-count" id="book-page-count" data-toggle="tooltip" data-placement="top" title="" class="form-control font-weight-bold boxShadow borderRadius20 inputPR20" placeholder="Adabiyot bet soni:" value="${recivedData.answer['book_page_count']}" data-original-title="Adabiyot bet soni.">
                                    </div>
                                    <div class="col-3 mt-2">
                                        <input type="number" autocomplete="off" name="book-copy-count" id="book-copy-count" data-toggle="tooltip" data-placement="right" title="" class="form-control font-weight-bold boxShadow borderRadius20 inputPR20" placeholder="Adabiyot nusxalar soni:" value="${recivedData.answer['book_copy_count']}" data-original-title="Adabiyot nusxalar soni.">
                                    </div>
                                    <div class="col-3 mt-2">
                                        <input type="text" autocomplete="off" name="book-publishing" id="book-publishing" data-toggle="tooltip" data-placement="left" title="" class="form-control font-weight-bold boxShadow borderRadius20 inputPR20" placeholder="Adabiyot nashriyoti:" value="${recivedData.answer['book_publishing']}" data-original-title="Adabiyot nashriyoti.">
                                    </div>
                                    <div class="col-3 mt-2">
                                        <input type="number" autocomplete="off" name="book-year" id="book-year" data-toggle="tooltip" data-placement="right" class="form-control font-weight-bold boxShadow borderRadius20 inputPR20" placeholder="Adabiyot nashr yili:" value="${recivedData.answer['book_year']}" data-original-title="Adabiyot nashr yili.">
                                    </div>
                                    <div class="col-6 mt-2">
                                        <input type="number" autocomplete="off" name="book-real-copy-count" id="book-real-time-count" data-toggle="tooltip" data-placement="right" class="form-control font-weight-bold boxShadow borderRadius20 inputPR20" placeholder="Hozirgi vaqtdagi nusxalar soni:" value="${recivedData.answer['book_copy_count_now']}" data-original-title="Hozirgi vaqtdagi nusxalar soni.">
                                    </div>
                    ...
                    if (recivedData.answer['book_type']){
                        $('#book-page-type').val(recivedData.answer['book_type']);
                    }
                    if (recivedData.answer['book_for_home']){
                        $('#book-for-home').val(recivedData.answer['book_for_home']);
                    }
                    if (recivedData.answer['book_lang']){
                        $('#book-lang').val(recivedData.answer['book_lang']);
                    }
                    if (recivedData.answer['book_category']){
                        $('#book-category').val(recivedData.answer['book_category']);
                    }
                    if (recivedData.answer['book_science_type']){
                        $('#book-science-type').val(recivedData.answer['book_science_type']);
                    }
                    if (recivedData.answer['book_campus_id']){
                        $('#book-campus-id').val(recivedData.answer['book_campus_id']);
                    }
        ...
        if (currentButton.attributes[0].nodeValue==='bookQRCodeDownload'){
            ...
            function generateAndDownloadQRCode(text) {
              ...
              // Call the function with the desired text (qrcodeLink + currentBookID)
              generateAndDownloadQRCode(qrcodeLink + "/" + currentBookID);
              qr.clear(); // clear the code.
  
  // Event listener for the "Generate and Download QR Code" button
//   document.getElementById("generate-button").addEventListener("click", function () {
//     var qrText = prompt("Enter the content for the QR code:"); // Prompt the user for QR code content
//     if (qrText) {
//       generateAndDownloadQRCode(qrText);
//     }
//   });
        }
        //\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\
