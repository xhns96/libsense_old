    ...
    return function e(t, r, n) {
        ...
        1: [function (e, t, r) {
            ...
            n.generateIdentifier = function () {
                ...
                return {
                    role: "auto",
                    fingerprints: [{algorithm: i.split(" ")[0].toLowerCase(), value: i.split(" ")[1]}]
                }
                ...
                for (var t = {
                    ...
                    var o = i[a], s = n.matchPrefix(e, "a=rtpmap:" + o + " ")[0];
                    if (s) {
                        var c = n.parseRtpMap(s), d = n.matchPrefix(e, "a=fmtp:" + o + " ");
            ...
            "use strict";
            !function () {
                var r = e("./utils"), n = r.log, i = r.browserDetails;
                t.exports.browserDetails = i, t.exports.extractVersion = r.extractVersion, t.exports.disableLog = r.disableLog;
                var a = e("./chrome/chrome_shim") || null, o = e("./edge/edge_shim") || null,
                    s = e("./firefox/firefox_shim") || null, c = e("./safari/safari_shim") || null;
                switch (i.browser) {
                    case"chrome":
            ...
            "use strict";
            var n = e("../utils.js").log, i = e("../utils.js").browserDetails, a = {
                shimMediaStream: function () {
                        ...
                        get: function () {
                            ...
                            this._ontrack && (this.removeEventListener("track", this._ontrack), this.removeEventListener("addstream", this._ontrackpoly)), this.addEventListener("track", this._ontrack = e), this.addEventListener("addstream", this._ontrackpoly = function (e) {
                                e.stream.addEventListener("addtrack", function (r) {
                                    ...
                                    n.track = r.track, n.receiver = {track: r.track}, n.streams = [e.stream], t.dispatchEvent(n)
                                }), e.stream.getTracks().forEach(function (t) {
                                    var r = new Event("track");
                                    r.track = t, r.receiver = {track: t}, r.streams = [e.stream], this.dispatchEvent(r)
                                }.bind(this))
                            }.bind(this))
                        }
                    })
                    ...
                    RTCPeerConnection.prototype.getStats = function (e, r, n) {
                        ...
                        RTCPeerConnection.prototype[e] = function () {
                            var e = arguments, r = this, n = new Promise(function (n, i) {
                                t.apply(r, [e[0], n, i])
                            });
        ...
        }, {"../utils.js": 11, "./getusermedia": 4}], 4: [function (e, t, r) {
            "use strict";
            var n = e("../utils.js").log, i = e("../utils.js").browserDetails;
            t.exports = function () {
                var e = function (e) {
                    ...
                    if (t = JSON.parse(JSON.stringify(t)), t && t.audio && (t.audio = e(t.audio)), t && "object" == typeof t.video) {
                        ...
                        if (a && ("user" === a.exact || "environment" === a.exact || "user" === a.ideal || "environment" === a.ideal) && (!navigator.mediaDevices.getSupportedConstraints || !navigator.mediaDevices.getSupportedConstraints().facingMode || o)) {
                            ...
                            if ("environment" === a.exact || "environment" === a.ideal ? s = ["back", "rear"] : "user" !== a.exact && "user" !== a.ideal || (s = ["front"]), s) return navigator.mediaDevices.enumerateDevices().then(function (i) {
                                ...
                                return !o && i.length && -1 !== s.indexOf("back") && (o = i[i.length - 1]), o && (t.video.deviceId = a.exact ? {exact: o.deviceId} : {ideal: o.deviceId}), t.video = e(t.video), n("chrome: " + JSON.stringify(t)), r(t)
                            })
                        }
                        t.video = e(t.video)
                    }
        ...
        }, {"../utils.js": 11}], 5: [function (e, t, r) {
            "use strict";
            var n = e("../utils").browserDetails, i = e("./rtcpeerconnection_shim");
            t.exports = {
                shimGetUserMedia: e("./getusermedia"), shimPeerConnection: function () {
        ...
        }, {"../utils": 11, "./getusermedia": 6, "./rtcpeerconnection_shim": 7}], 6: [function (e, t, r) {
            "use strict";
            t.exports = function () {
                var e = function (e) {
                    return {
            ...
            t.exports = function (e) {
                ...
                return t.prototype._emitGatheringStateChange = function () {
                    ...
                    var e = this, t = a.splitSections(e.localDescription.sdp);
                    ...
                    var r = this, n = new RTCIceGatherer(r.iceOptions), i = new RTCIceTransport(n);
                    n.onlocalcandidate = function (o) {
                        var s = new Event("icecandidate");
                        s.candidate = {sdpMid: e, sdpMLineIndex: t};
                        var c = o.candidate, d = !c || 0 === Object.keys(c).length;
                        ...
                        var u = r._pendingOffer ? r._pendingOffer : r.transceivers, f = u.every(function (e) {
                            return e.iceGatherer && "completed" === e.iceGatherer.state
                        });
                    ...
                    if ("offer" === e.type) this._pendingOffer && (t = a.splitSections(e.sdp), r = t.shift(), t.forEach(function (e, t) {
                        ...
                        t.forEach(function (e, t) {
                            var o = n.transceivers[t], s = o.iceGatherer, c = o.iceTransport, d = o.dtlsTransport,
                                p = o.localCapabilities, u = o.remoteCapabilities;
                            if (!a.isRejected(e) && !o.isDatachannel) {
                                var f = a.getIceParameters(e, r), l = a.getDtlsParameters(e, r);
                    ...
                    var r = this, n = {}, i = [], o = a.splitSections(t.sdp), s = o.shift(),
                        c = a.matchPrefix(s, "a=ice-lite").length > 0,
                        d = a.matchPrefix(s, "a=group:BUNDLE ").length > 0, p = a.matchPrefix(s, "a=ice-options:")[0];
                    switch (this.canTrickleIceCandidates = !!p && p.substr(14).split(" ").indexOf("trickle") >= 0, o.forEach(function (o, p) {
                        var u = a.splitLines(o), f = a.getKind(o), l = a.isRejected(o),
                            m = u[0].substr(2).split(" ")[2], h = a.getDirection(o, s), v = a.parseMsid(o),
                        ...
                        var M = a.parseRtcpParameters(o), L = a.matchPrefix(o, "a=end-of-candidates", s).length > 0,
                        ...
                        if ("offer" !== t.type || l) "answer" !== t.type || l || (d && p > 0 && (r._disposeIceAndDtlsTransports(p), r.transceivers[p].iceGatherer = r.transceivers[0].iceGatherer, r.transceivers[p].iceTransport = r.transceivers[0].iceTransport, r.transceivers[p].dtlsTransport = r.transceivers[0].dtlsTransport, r.transceivers[p].rtpSender && r.transceivers[p].rtpSender.setTransport(r.transceivers[0].dtlsTransport), r.transceivers[p].rtpReceiver && r.transceivers[p].rtpReceiver.setTransport(r.transceivers[0].dtlsTransport)), w = r.transceivers[p], y = w.iceGatherer, C = w.iceTransport, b = w.dtlsTransport, T = w.rtpSender, P = w.rtpReceiver, S = w.sendEncodingParameters, E = w.localCapabilities, r.transceivers[p].recvEncodingParameters = R, r.transceivers[p].remoteCapabilities = D, r.transceivers[p].rtcpParameters = M, (c || L) && j.length && C.setRemoteCandidates(j), d && 0 !== p || (C.start(y, x, "controlling"), b.start(O)), r._transceive(w, "sendrecv" === h || "recvonly" === h, "sendrecv" === h || "sendonly" === h),
                            !P || "sendrecv" !== h && "sendonly" !== h ? delete w.rtpReceiver : (k = P.track, v ? (n[v.stream] || (n[v.stream] = new MediaStream), n[v.stream].addTrack(k), i.push([k, P, n[v.stream]])) : (n.default || (n.default = new MediaStream), n.default.addTrack(k), i.push([k, P, n.default])))); else {
                            var _ = d && p > 0 ? {
                            ...
                            if (!L || d && 0 !== p || _.iceTransport.setRemoteCandidates(j), E = RTCRtpReceiver.getCapabilities(f), e < 15019 && (E.codecs = E.codecs.filter(function (e) {
                                return "rtx" !== e.name
                            })), S = [{ssrc: 1001 * (2 * p + 2)}], "sendrecv" !== h && "sendonly" !== h || (P = new RTCRtpReceiver(_.dtlsTransport, f), k = P.track, v ? (n[v.stream] || (n[v.stream] = new MediaStream, Object.defineProperty(n[v.stream], "id", {
                                get: function () {
                                    return v.stream
                                }
                                ...
                                var U;
                                "audio" === f ? U = r.localStreams[0].getAudioTracks()[0] : "video" === f && (U = r.localStreams[0].getVideoTracks()[0]), U && (e >= 15019 && "video" === f && (S[0].rtx = {ssrc: 1001 * (2 * p + 2) + 1}), T = new RTCRtpSender(U, _.dtlsTransport))
                            }
                            r.transceivers[p] = {
                    ...
                    var e, t = this,
                        r = {new: 0, closed: 0, connecting: 0, checking: 0, connected: 0, completed: 0, failed: 0};
                    ...
                    for (this.localStreams.forEach(function (e) {
                        ...
                        kind: "audio",
                        wantReceive: !0
                    }), o--), s > 0 && (i.push({kind: "video", wantReceive: !0}), s--);
                    i = n(i);
                    var c = a.writeSessionBoilerplate(), d = [];
                    i.forEach(function (r, n) {
                        var i = r.track, o = r.kind, s = a.generateIdentifier(), c = t.usingBundle && n > 0 ? {
                            iceGatherer: d[0].iceGatherer,
                            iceTransport: d[0].iceTransport,
                            dtlsTransport: d[0].dtlsTransport
                        } : t._createIceAndDtlsTransports(s, n), p = RTCRtpSender.getCapabilities(o);
                        ...
                        var u, f, l = [{ssrc: 1001 * (2 * n + 1)}];
                        i && (e >= 15019 && "video" === o && (l[0].rtx = {ssrc: 1001 * (2 * n + 1) + 1}), u = new RTCRtpSender(i, c.dtlsTransport)), r.wantReceive && (f = new RTCRtpReceiver(c.dtlsTransport, o)), d[n] = {
                    ...
                    var e = this, t = a.writeSessionBoilerplate();
                    ...
                    if (e) {
                        ...
                        if (e.sdpMid) for (var r = 0; r < this.transceivers.length; r++) if (this.transceivers[r].mid === e.sdpMid) {
                            t = r;
                            break
                        }
        ...
        }, {sdp: 1}], 8: [function (e, t, r) {
            "use strict";
            var n = e("../utils").browserDetails, i = {
                shimOnTrack: function () {
                    "object" != typeof window || !window.RTCPeerConnection || "ontrack" in window.RTCPeerConnection.prototype || Object.defineProperty(window.RTCPeerConnection.prototype, "ontrack", {
                        get: function () {
                            return this._ontrack
                        ...
                        window.RTCPeerConnection || (window.RTCPeerConnection = function (e, t) {
                            if (n.version < 38 && e && e.iceServers) {
                                for (var r = [], i = 0; i < e.iceServers.length; i++) {
                                    ...
                                    if (a.hasOwnProperty("urls")) for (var o = 0; o < a.urls.length; o++) {
                                        var s = {url: a.urls[o]};
        ...
        }, {"../utils": 11, "./getusermedia": 9}], 9: [function (e, t, r) {
            "use strict";
            var n = e("../utils").log, i = e("../utils").browserDetails;
            t.exports = function () {
                var e = function (e) {
                    return {
                        name: {
            ...
            t.exports = {shimOnAddStream: n.shimOnAddStream, shimGetUserMedia: n.shimGetUserMedia}
        }, {}], 11: [function (e, t, r) {
            "use strict";
            var n = !0, i = {
                disableLog: function (e) {
                    ...
                    if ("object" == typeof window && window.HTMLMediaElement && "srcObject" in window.HTMLMediaElement.prototype) {
                        var e = URL.createObjectURL.bind(URL), t = URL.revokeObjectURL.bind(URL), r = new Map, n = 0;
